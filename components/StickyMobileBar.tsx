...
export default function StickyMobileBar() {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-50 lg:hidden bg-white border-t border-border-subtle shadow-[0_-4px_16px_rgba(0,0,0,0.06)] px-3 py-2.5 flex items-center gap-3">
